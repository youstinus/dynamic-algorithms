...
namespace _2AcyclicGraph.Models
{
    ...
    {
        public readonly List<TV> VertexSet = new List<TV>();
        public readonly List<IPairValue<TV>> EdgeSet = new List<IPairValue<TV>>();
        public readonly Dictionary<IPairValue<TV>, TK> Weigths = new Dictionary<IPairValue<TV>, TK>();
